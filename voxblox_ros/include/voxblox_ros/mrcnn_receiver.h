#ifndef VOXBLOX_MRCNN_RECEIVER_H_
#define VOXBLOX_MRCNN_RECEIVER_H_
...
namespace voxblox {
    ...
    struct image_point {
        int x;
        int y;
        image_point(int xi, int yi){
            x = xi;
            y = yi;
        }
    };

    class MrcnnReceiver : public TsdfSeqReceiver {

        public:
            MrcnnReceiver(const ros::NodeHandle& nh, const ros::NodeHandle& nh_private,
            ...
            void cnn_callback2(const mask_rcnn_ros::Result res);
        ...
        protected:
            ...
            void initialize_weight(boost::function<void (const sensor_msgs::ImageConstPtr&, const sensor_msgs::ImageConstPtr&, const sensor_msgs::CameraInfoConstPtr&, const sensor_msgs::CameraInfoConstPtr&,
            ...
            std::vector<cv::Vec3d> image_coord_map;
