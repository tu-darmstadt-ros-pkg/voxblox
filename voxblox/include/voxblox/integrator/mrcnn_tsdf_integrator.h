#ifndef VOXBLOX_INTEGRATOR_MRCNN_TSDF_INTEGRATOR_H_
#define VOXBLOX_INTEGRATOR_MRCNN_TSDF_INTEGRATOR_H_
//all from seg_tsdf_integrator
#include <algorithm>
#include <atomic>
#include <cmath>
#include <deque>
...
class MrcnnTsdfIntegrator {
 public:
  ...
  MrcnnTsdfIntegrator(const Config& config, Layer<TsdfVoxel>* tsdf_layer,
